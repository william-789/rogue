...
class Interface {
    ...
    #processStatusImage(image) {
        ...
        element.src = "rogue/images/" + image.image;
    ...
    update() {
        this.#images.forEach(image => {
            ...
            if(image.element.src !== location.origin + "rogue/images/" + image.image.image) {
                image.element.src = "rogue/images/" + image.image.image;
            }
        });
